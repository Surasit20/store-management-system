...
function CardCar1(props) {
  ...
  <Grid item xs={5}>
    ...
    <Card orientation="horizontal" variant="outlined" sx={{ height:300 }}>
        <CardActionArea>

<AspectRatio ratio="1" sx={{ width: 300,height:300 }}>
          <img
          src={
  ...
  <Grid item xs={6}>
    ...
    <Card orientation="horizontal"  variant="solid" sx={{ width: 300,height:300 }}>
        <CardActionArea>
        <div style={{justifyContent: "space-between",display: "flex",height:"300px",flexDirection: "column"}}>
          <CardContent style={{justifyContent: "space-between",display: "flex",height:"300px",flexDirection: "column"}}>
